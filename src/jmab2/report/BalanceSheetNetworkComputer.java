 ...
 */
public class BalanceSheetNetworkComputer extends AbstractMicroComputer implements
MicroMultipleVariablesComputer {
	...
	public BalanceSheetNetworkComputer(){}
	 ...
	 * @param fileName
	 */
	public BalanceSheetNetworkComputer(int[] populationsId, int[] assetsId,
			...
			for (Agent i:pop.getAgents()){
				...
				if (!agent.isDead()){
					...
					for(int assetId:assetsId){
						...
						for (Item j:assets){
							if(populations.contains(j.getLiabilityHolder().getPopulationId())){
								long liabId = j.getLiabilityHolder().getAgentId();
