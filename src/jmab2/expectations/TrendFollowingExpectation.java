 ...
 *
 */
public class TrendFollowingExpectation implements Expectation {
	 ...
	 * 
	 */
	public TrendFollowingExpectation() {
	}
	...
	public void updateExpectation() {
		double result=passedValues[0][0]+adaptiveParam*(passedValues [0][0]-passedValues[1][0]);
